    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('Admin', 'Administrador'), ('Bodeguero', 'Bodeguero'), ('Cajero', 'Cajero')], default='Cajero', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_proveedor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.proveedor')),
            ],
        ),
        migrations.CreateModel(
            name='detalle_compra',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metodo_pago', models.CharField(choices=[('Efectivo', 'Efectivo'), ('Debito', 'Debito')], default='Efectivo', max_length=20)),
                ('id_usuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
